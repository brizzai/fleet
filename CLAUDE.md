...
internal/ui/drawer.go            # Terminal drawer (` key): dark bottom shells panel — render, slide animation, focus/key handling, shell lifecycle
